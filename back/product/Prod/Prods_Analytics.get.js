api = "https://example.com/api/b1/Prods_Analys";
...
args = {
	...
	field: {required: true, type: 'String', description: "给出分析字段"},
	boundaries: {required: true, type: Array[String], description: "分段属性, 比如:[0, 1, 10, 100]"},
	outputs: {required: true, type: Array[String], description: "输出的种类"},
